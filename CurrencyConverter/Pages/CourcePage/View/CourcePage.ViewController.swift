//
//  CourcePage.ViewController.swift
//  CurrencyConverter
//
...
protocol CourcePageViewInput: AnyObject {}

protocol CourcePageViewOutput {}

extension CourcePage {

	final class ViewController: UIViewController, CourcePageViewInput {

		var presenter: CourcePageViewOutput?
		...
		private func configureTableView() {
			...
			myCollectionView.register(CourcePage.Cell.self, forCellWithReuseIdentifier: CourcePage.Cell.identifier)
		...
		private func addConstraints() {
			...
			NSLayoutConstraint.activate([
				...
				myCollectionView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -100),
			])
...
extension CourcePage.ViewController: UICollectionViewDelegate, UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		guard let cell = myCollectionView.dequeueReusableCell(withReuseIdentifier: CourcePage.Cell.identifier, for: indexPath) as? CourcePage.Cell else { return UICollectionViewCell() }
...
extension CourcePage.ViewController: UICollectionViewDelegateFlowLayout {
