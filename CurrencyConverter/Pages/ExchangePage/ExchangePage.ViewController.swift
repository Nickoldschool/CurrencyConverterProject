//
//  ExchangePage.ViewController.swift
//  CurrencyConverter
//
...
extension ExchangePage {
	...
	final class ViewController: UIViewController, ExchangePageViewControllerInput {
...
extension ExchangePage.ViewController: UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
